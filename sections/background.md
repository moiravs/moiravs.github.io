...
<div align="center" class="my-8 center ">
  ...
  <caption class="m-px italic font-sans antialiased text-xs text-current mt-2 block text-center">Figure 1: The highway model, with a shortcut in blue, that improves the diameter.</caption>
</div>
